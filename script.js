...
let Image = document.getElementById('bkmark'); 
		...
		Image.src = "blackbookmark.png"; 
		} 
		else { 
		Image.src = "bookmark-white.png";}
	}
function bookmark1(){
let Image1 = document.getElementById('bkmark1'); 
		if (Image1.src.match("bookmark-white")){
		Image1.src = "blackbookmark.png"; 
		} 
		else {
		Image1.src = "bookmark-white.png";}
		}
function bookmark2(){
let Image2 = document.getElementById('bkmark2'); 
		if (Image2.src.match("bookmark-white")){
		Image2.src = "blackbookmark.png"; 
		} 
		else { 
		Image2.src = "bookmark-white.png";}	
	}